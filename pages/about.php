<section class="py-5 text-center container">
    <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Sobre este BLOG</h1>
            <p class="lead text-body-secondary">
                Nosso objetivo é fornecer conteúdo relevante, confiável e acessível, abordando assuntos que tocam a vida das pessoas. 
                Aqui você encontra notícias, análises, dicas e muito mais, sempre com um olhar crítico e informativo. Seja bem-vindo(a) ao nosso blog!
            </p>
            <!-- <p>
...
<section class="content">
    ...
    <div class="mb-2 mb-md-5 text-justify">
        ...
        <ul>
            ...
            <li>Qualidade: Nosso foco está sempre em oferecer conteúdo bem pesquisado, relevante e bem escrito, para que cada artigo seja útil e interessante para o leitor.</li>
            <li>Inovação: Estamos sempre em busca de novas maneiras de criar e compartilhar conteúdo, utilizando as mais recentes ferramentas tecnológicas para tornar a experiência do leitor mais rica e interativa.</li>
            <li>Responsabilidade: Sabemos que a informação tem um poder enorme. Portanto, nos comprometemos a publicar conteúdos que respeitem os direitos e a dignidade de todos os indivíduos.</li>
            <li>Diversidade: Acreditamos que o mundo é multifacetado e que cada pessoa tem uma visão única. Nosso blog acolhe e celebra a diversidade de opiniões, culturas e perspectivas.</li>
